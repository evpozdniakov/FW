...
class Field{
	...
	function getFieldTagOrViewTemplate($params_arr){
		...
		$view_template_file=$_SERVER['DOCUMENT_ROOT'].'/admin/models/'.$this->model_name.'/'.$this->db_column.'.viewtemplate.php';
	...
	function getFormFieldHTMLtag($params_arr){
		...
		*/
		...
		include($_SERVER['DOCUMENT_ROOT'].'/admin/fw/classes/templates/field/'.$this->__name__.'.php');//return 'поле формы со значением <pre>'.e5c($data).'</pre><br>';
   ...
   * 
	...
	function _getHTML($inputValue){
		include($_SERVER['DOCUMENT_ROOT'].'/admin/fw/classes/templates/field/'.$this->className.'.php');
		return $result;
	}
...
include($_SERVER['DOCUMENT_ROOT'].'/admin/fw/classes/interface.subfields.class.php');
include($_SERVER['DOCUMENT_ROOT'].'/admin/fw/classes/field.tree.class.php');
include($_SERVER['DOCUMENT_ROOT'].'/admin/fw/classes/field.foreignkey.class.php');
include($_SERVER['DOCUMENT_ROOT'].'/admin/fw/classes/field.order.class.php');
include($_SERVER['DOCUMENT_ROOT'].'/admin/fw/classes/field.date.class.php');
include($_SERVER['DOCUMENT_ROOT'].'/admin/fw/classes/field.datetime.class.php');
include($_SERVER['DOCUMENT_ROOT'].'/admin/fw/classes/field.file.class.php');
include($_SERVER['DOCUMENT_ROOT'].'/admin/fw/classes/field.image.class.php');
include($_SERVER['DOCUMENT_ROOT'].'/admin/fw/classes/field.flv.class.php');
include($_SERVER['DOCUMENT_ROOT'].'/admin/fw/classes/field.manytomany.class.php');
include($_SERVER['DOCUMENT_ROOT'].'/admin/fw/classes/field.captcha.class.php');
include($_SERVER['DOCUMENT_ROOT'].'/admin/fw/classes/field.gmap.class.php');
include($_SERVER['DOCUMENT_ROOT'].'/admin/fw/classes/field.yamap.class.php');
