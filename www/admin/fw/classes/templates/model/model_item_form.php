...
$result='
	...
	<form id="model_'.$this->__name__.'_form" class="adminForm" name="model_'.$this->__name__.'_form" action="'.DOMAIN_PATH.$_SERVER['REDIRECT_URL'].'edit/" method="post" enctype="multipart/form-data" accept-charset="'.SITE_ENCODING.'" '.$local->getOnsubmit().'>
		<div>
		'
