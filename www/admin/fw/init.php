...
function _connectDB(){
	...
	include(SITE_DIR.'/admin/fw/classes/db.class.php');
	$db=new DB();
	$db->connect();
}
...
function _includeClasses(){
	include(SITE_DIR.'/admin/fw/classes/compressor.class.php');
	if(USE_FW===false){return;}
	include(SITE_DIR.'/admin/fw/classes/admin.class.php');
	include(SITE_DIR.'/admin/fw/classes/model.class.php');
	include(SITE_DIR.'/admin/fw/classes/modelmanager.class.php');
	include(SITE_DIR.'/admin/fw/classes/field.class.php');
	include(SITE_DIR.'/admin/fw/classes/formitems.class.php');
	...
	include(SITE_DIR.'/admin/fw/classes/model.cache.class.php'); 
	include(SITE_DIR.'/admin/fw/classes/model.models.class.php');
	if(false
